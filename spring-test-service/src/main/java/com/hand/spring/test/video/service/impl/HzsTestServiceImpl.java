...
import com.hand.spring.test.video.mapper.HzsStudentMapper;
 ...
 */
@Service
public class HzsTestServiceImpl implements IHzsTestService {

    @Autowired
    private MongoTemplate mongoTemplate;

    @Autowired
    private HzsStudentMapper mapper;

    @Autowired
    private RedisTemplate redisTemplate;

    @Autowired
    private IHzsTestService service;
    ...
    @Override
    public List<HzsStudent> select(int page, int pageSize) {
